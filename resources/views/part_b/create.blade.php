...
@section('container')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['method' => 'POST', 'route'=> 'part_b.store']) !!}
            ...
            <div class="form-group" hidden>
                ...
                <input name="studio_id" class="form-control" placeholder="Studio ID" value="{{ old('studio_id') or '' }}" readonly/>
            </div>
            <div class="form-group">
                <label class="form-label">Studio Name</label>
                <input name="studio_name" class="form-control" placeholder="Studio Name" value="{{ old('studio_name') or '' }}"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="address_1" class="form-control" placeholder="Address 1" value="{{ old('address_1') or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Address 2</label>
                <input name="address_2" class="form-control" placeholder="Address 2" value="{{ old('address_2') or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Address 3</label>
                <input name="address_3" class="form-control" placeholder="Address 3" value="{{ old('address_3') or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Post Code</label>
                <input name="post_code" class="form-control" placeholder="Post Code" value="{{ old('post_code') or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Tel</label>
                <input name="tel" class="form-control" placeholder="Tel" value="{{ old('tel') or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Examination Day Contact Tel</label>
                <input name="examination_day_contact_tel" class="form-control" placeholder="Examination Day Contact Tel" value="{{ old('examination_day_contact_tel') or '' }}"/>
            </div>
