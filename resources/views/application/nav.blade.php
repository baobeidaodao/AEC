...
<div class="card">
    <div class="card-body">
        @if(isset($application) && !empty($application) && isset($application['id']) && !empty($application['id']))
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">Part B</a>
            @endif
            <a class="btn btn-sm"><i class="fe fe-chevrons-right"></i></a>
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">Part C</a>
            @endif
            <a class="btn btn-sm"><i class="fe fe-chevrons-right"></i></a>
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">Part D</a>
            @endif
            <a class="btn btn-sm"><i class="fe fe-chevrons-right"></i></a>
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">Part E</a>
            @endif
            <a class="btn btn-sm"><i class="fe fe-chevrons-right"></i></a>
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">Part F</a>
            @endif
        @endif
        ...
        @if(isset($application) && !empty($application) && isset($application['id']) && !empty($application['id']))
            ...
            @if(isset($application['exam']) && !empty($application['exam']) && isset($application['exam']['id']) && !empty($application['exam']['id']))
                <a href="{{url('/admin/exam/' . $application['exam']['id'])}}"
                   class="btn btn-sm @if(isset($nav) && $nav=='exam') @if($application['exam']['check']==1) btn-success @else btn-danger @endif @else @if($application['exam']['check']==1) btn-outline-success @else btn-outline-danger @endif @endif">AEC2</a>
            @elseif(isset($exam) && !empty($exam) && isset($exam['id']) && !empty($exam['id'])))
            <a href="{{url('/admin/exam/' . $exam['id'])}}"
               class="btn btn-sm @if(isset($nav) && $nav=='exam') @if($exam['check']==1) btn-success @else btn-danger @endif @else @if($exam['check']==1) btn-outline-success @else btn-outline-danger @endif @endif">AEC2</a>
            ...
            @else
                <a href="javascript:void(0);" class="btn btn-sm btn-outline-dark">AEC2</a>
            @endif
        @endif
