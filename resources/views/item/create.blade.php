    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="number" class="form-control" placeholder="Number" value="{{ count($group['item_list']) + 1 }}" readonly/>
            </div>
            <div class="form-group">
                <label class="form-label">Candidate ID No</label>
                <input name="student_number" class="form-control" placeholder="Candidate ID No" value="{{ old('student_number') }}"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @include('public.datetime_picker', ['id' => 'birthDate', 'name' => 'birth_date', 'placeholder' => 'birth_date', 'value' => old('birth_date'), 'format'=>'yyyy-mm-dd',])
            </div>
            <div class="form-group">
                <div class="form-label">Sex</div>
                <div class="custom-controls-stacked">
                    <label class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" name="sex" value="1" @if(old('sex')===1||old('sex')==='1') checked @endif>
                        <span class="custom-control-label">M</span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" name="sex" value="0" @if(old('sex')===0||old('sex')==='0') checked @endif>
                ...
                <div>
                    @foreach($partCTeacherList as $partCTeacher)
                        <label class="custom-control custom-checkbox custom-control-inline">
                            <input type="checkbox" class="custom-control-input" name="part_c_teacher_id[]" value="{{$partCTeacher['id'] or ''}}"
