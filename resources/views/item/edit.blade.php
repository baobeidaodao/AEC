    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="group_id" class="form-control" placeholder="Group ID" value="{{ $item['group']['id'] or '' }}" readonly/>
            </div>
            <div class="form-group">
                <label class="form-label">Number</label>
                <input name="number" class="form-control" placeholder="Number" value="{{ $item['number'] or '' }}" readonly/>
            </div>
            <div class="form-group">
                <label class="form-label">Candidate ID No</label>
                <input name="student_number" class="form-control" placeholder="Candidate ID No" value="{{ $item['student']['number'] or '' }}"/>
            </div>
            <div class="form-group">
                <label class="form-label">Given Name</label>
                <input name="given_name" class="form-control" placeholder="Given Name" value="{{ $item['student']['given_name'] or '' }}"/>
            </div>
            <div class="form-group">
                ...
                <div>
                    @foreach($partCTeacherList as $partCTeacher)
                        <label class="custom-control custom-checkbox custom-control-inline">
                            <input type="checkbox" class="custom-control-input" name="part_c_teacher_id[]" value="{{$partCTeacher['id'] or ''}}" @if(in_array($partCTeacher['id'], $partCTeacherIdList)) checked @endif>
