    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                @include('public.datetime_picker', ['id' => 'examTime', 'name' => 'exam_time', 'placeholder' => 'exam_time', 'value' => date('H:i', strtotime($section['exam_time'])), 'datetime' => $section['exam_time'], 'format' => 'hh:ii', 'startView' => 0])
            </div>
